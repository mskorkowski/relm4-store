...
use store::{FactoryBuilder, Position, window::WindowBehavior};
...
pub struct TaskFactoryBuilder<W: WindowBehavior> {
    _window: PhantomData<*const W>,
}

impl<W: WindowBehavior> FactoryBuilder for TaskFactoryBuilder<W> {
    type Store = Tasks;
