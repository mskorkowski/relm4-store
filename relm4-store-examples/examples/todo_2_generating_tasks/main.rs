...
fn main() -> Result<()> {
    log4rs::init_file("relm4-store-examples/examples/todo_2_generating_tasks/etc/log4rs.yaml", Default::default()).unwrap();
    ...
    let app_id = "store.relm4.example.todo-2-generating-tasks";
