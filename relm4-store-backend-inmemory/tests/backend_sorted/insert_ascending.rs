...
mod empty {
    ...
    use crate::common::TestRecordsConfigAscEmpty;

    type TestRecords = TestRecordsBase<TestRecordsConfigAscEmpty>;
    ...
    fn insert_second_asc() {
        ...
        let data = vec![new_record1, new_record2];
        let range_from_store = store.get_range(&Range::new(0, 10));
        assert_eq!(range_from_store, data, "Value returned from store and expected data must match");
    }
    ...
    mod single_step {
        ...
        fn insert_third_beginning() {
            ...
            let data = vec![new_record3, new_record1, new_record2];
            let range_from_store = store.get_range(&Range::new(0, 10));
            assert_eq!(range_from_store, data, "Value returned from store and expected data must match");
        }
        ...
        fn insert_third_middle() {
            ...
            let data = vec![new_record1, new_record3, new_record2];
            let range_from_store = store.get_range(&Range::new(0, 10));
            assert_eq!(range_from_store, data, "Value returned from store and expected data must match");
        }
        ...
        fn insert_third_end() {
            ...
            let data = vec![new_record1, new_record2, new_record3];
            let range_from_store = store.get_range(&Range::new(0, 10));
            assert_eq!(range_from_store, data, "Value returned from store and expected data must match");
        }
    }
